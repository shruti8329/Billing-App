...
public class SettingService {
	...
	public SettingMaster updateSettingss(int settingid, String business_name, String business_mobile, String business_email, String business_address, String business_gst_number, MultipartFile image) throws IOException{
		SettingMaster setting = settingRepo.findById(settingid).orElseThrow(() -> new RuntimeException("Setting Not Found"));
		setting.setBusiness_name(business_name);
		setting.setBusiness_mobile(business_mobile);
		setting.setBusiness_address(business_address);
		setting.setBusiness_email(business_email);
